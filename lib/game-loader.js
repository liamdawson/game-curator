...
import {MarkdownConverter} from '../src/classes/value-converters/markdown-format.js';
...
module.exports = function (source) {
  ...
  var marked = new MarkdownConverter();
  ...
  switch(metaDoc.game_curator_schema)
  {
    case 2:
      ...
      game.description_html = marked.toView(game.description);
